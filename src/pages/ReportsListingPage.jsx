        ...
        <Box sx={{ bgcolor: 'background.default', minHeight: '100vh' }}>
            ...
            <Box sx={{ pt: 10, display: 'flex', maxWidth: '100%', px: { lg: 4 }, minHeight: '100vh' }}>
                ...
                >
                    <Stack spacing={4}>
                        <Box>
                            <Typography variant="caption" sx={{ textTransform: 'uppercase', letterSpacing: '0.1em', fontWeight: 700, color: 'text.secondary', mb: 2, display: 'block' }}>Filters</Typography>
                ...
                {/* Main Content */}
                <Box component="main" sx={{ flexGrow: 1, p: { xs: 2, md: 3 }, pl: { lg: 4 } }}>
                    <Stack direction={{ xs: 'column', md: 'row' }} justifyContent="space-between" alignItems={{ md: 'flex-end' }} gap={2} sx={{ mb: 5 }}>
                        <Box>
                            ...
                            <Typography variant="h3" sx={{ fontFamily: '"Playfair Display", serif' }}>Industry Reports</Typography>
                        </Box>
